	...
	<div class="container">
		<div class="technology row">
			...
			<div class="col-md-8 blog_left">
				<h4><a href="single-page.html">International Conference On Intelligent Communication And Computational Techniques.</a></h4>
				<a href="single-page.html"><img src="login/images/blog_pic1.jpg" alt="" class="blog_img img-responsive"/></a>
				<div class="blog_list">
					  <ul class="list-unstyled">
						<li><i class="fa fa-calendar-o"></i><span>December 22 - 23, 2017</span></li>
					  </ul>
				</div>
				<p class="para" style="text-align:justify" >ICCT17 will serve as a platform for knowledge sharing about the recent trends and advancements in the field of networking and high end data handling and how these domains are playing role in research and market development of the industries. It will provide great opportunity for our students and faculties to interact and share ideas with the top-notch in the field face to face. This knowledge sharing may inspire and thrill many young minds and help us bring collaborations and global partners to work together. This will enable us to solve challenging problems in our society so that we may contribute to our world. The whole idea of the forum is to exchange thoughts and ideas, transform those in real time to solve the problems. Conference will also create awareness in students about the importance of scientific research in related fields and synchronizing with product market.<br><br><h3>For more information please visit:<a href="icct.co.in"> www.icct.co.in</a></h3></p>
				<!-- <div class="read_more">
